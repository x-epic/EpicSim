 ...
 */
extern void wide_inputs_connect(vvp_wide_fun_core *core, unsigned argc,
                                struct symb_s *argv);
...
extern void compile_functor(char *label, char *type, unsigned width,
                            unsigned ostr0, unsigned ostr1, unsigned argc,
                            struct symb_s *argv);
 ...
 */
extern void compile_resolver(char *label, char *type, unsigned argc,
                             struct symb_s *argv);

extern void compile_concat(char *label, unsigned w0, unsigned w1, unsigned w2,
                           unsigned w3, unsigned argc, struct symb_s *argv);

extern void compile_concat8(char *label, unsigned w0, unsigned w1, unsigned w2,
                            unsigned w3, unsigned argc, struct symb_s *argv);

extern void compile_substitute(char *label, unsigned width, unsigned soff,
                               unsigned swidth, unsigned argc,
                               struct symb_s *argv);
 ...
 */
extern void compile_delay(char *label, unsigned width, vvp_delay_t *del,
                          struct symb_s input);
extern void compile_delay(char *label, unsigned width, unsigned argc,
                          struct symb_s *argv, bool ignore_decay);

/*
 * This is called by the parser to create a part select node.
 * See the PART SELECT STATEMENT section in the README.txt
 */
extern void compile_part_select(char *label, char *src, unsigned base,
                                unsigned wid);
extern void compile_part_select_pv(char *label, char *src, unsigned base,
                                   unsigned wid, unsigned vec_wid);
extern void compile_part_select_var(char *label, char *src, char *var,
...
extern void compile_arith_abs(char *label, unsigned argc, struct symb_s *argv);
extern void compile_arith_cast_int(char *label, long width, unsigned argc,
                                   struct symb_s *argv);
extern void compile_arith_cast_real(char *label, bool signed_flag,
                                    unsigned argc, struct symb_s *argv);
extern void compile_arith_cast_vec2(char *label, long width, unsigned argc,
                                    struct symb_s *argv);
...
extern void compile_arith_mod(char *label, long width, bool signed_flag,
                              unsigned argc, struct symb_s *argv);
extern void compile_arith_mult(char *label, long width, unsigned argc,
                               struct symb_s *argv);
extern void compile_arith_sum(char *label, long width, unsigned argc,
                              struct symb_s *argv);
extern void compile_arith_sub(char *label, long width, unsigned argc,
                              struct symb_s *argv);
extern void compile_cmp_eeq(char *label, long width, unsigned argc,
                            struct symb_s *argv);
extern void compile_cmp_nee(char *label, long width, unsigned argc,
                            struct symb_s *argv);
extern void compile_cmp_eq(char *label, long width, unsigned argc,
                           struct symb_s *argv);
extern void compile_cmp_eqx(char *label, long width, unsigned argc,
                            struct symb_s *argv);
extern void compile_cmp_eqz(char *label, long width, unsigned argc,
                            struct symb_s *argv);
extern void compile_cmp_ne(char *label, long width, unsigned argc,
                           struct symb_s *argv);
...
extern void compile_cmp_gt(char *label, long width, bool signed_flag,
                           unsigned argc, struct symb_s *argv);
extern void compile_cmp_weq(char *label, long width, unsigned argc,
                            struct symb_s *argv);
extern void compile_cmp_wne(char *label, long width, unsigned argc,
                            struct symb_s *argv);

extern void compile_arith_mult_r(char *label, unsigned argc,
                                 struct symb_s *argv);
extern void compile_arith_pow_r(char *label, unsigned argc,
                                struct symb_s *argv);
extern void compile_arith_div_r(char *label, unsigned argc,
                                struct symb_s *argv);
extern void compile_arith_mod_r(char *label, unsigned argc,
                                struct symb_s *argv);
extern void compile_arith_sum_r(char *label, unsigned argc,
                                struct symb_s *argv);
extern void compile_arith_sub_r(char *label, unsigned argc,
                                struct symb_s *argv);
...
extern void compile_latch(char *label, unsigned width, struct symb_s arg_d,
                          struct symb_s arg_e);
...
struct __vpiModPath;
extern __vpiModPath *compile_modpath(char *label, unsigned width,
                                     struct symb_s drv, struct symb_s dest);
extern void compile_modpath_src(__vpiModPath *dst, char edge,
                                const struct symb_s &src, struct numbv_s &vals,
                                const struct symb_s &condit_src,
                                const struct symb_s &path_term_in);
extern void compile_modpath_src(__vpiModPath *dst, char edge,
                                const struct symb_s &src, struct numbv_s &vals,
                                int condit_src, /* match with '0' */
                                const struct symb_s &path_term_in, bool ifnone);
...
extern void compile_sfunc(char *label, char *name, char *format_string,
                          long file_idx, long lineno, unsigned argc,
                          struct symb_s *argv, char *trigger_label);

extern void compile_repeat(char *label, long width, long repeat,
                           struct symb_s arg);

extern void compile_shiftl(char *label, long width, unsigned argc,
                           struct symb_s *argv);
...
class resolv_list_s {
 public:
  explicit resolv_list_s(char *lab) : label_(lab) { next = NULL; }
...
extern void compile_udp_def(int sequ, char *label, char *name, unsigned nin,
                            unsigned init, char **table);

extern void compile_udp_functor(char *label, char *type, unsigned argc,
                                struct symb_s *argv);
...
extern void compile_var_array(char *label, char *name, int last, int first,
                              int msb, int lsb, char signed_flag);
extern void compile_var2_array(char *label, char *name, int last, int first,
                               int msb, int lsb, bool signed_flag);
extern void compile_real_array(char *label, char *name, int last, int first);
extern void compile_string_array(char *label, char *name, int last, int first);
extern void compile_object_array(char *label, char *name, int last, int first);
extern void compile_net_array(char *label, char *name, int last, int first);
 ...
 * the threads.
 */
extern void compile_event(char *label, char *type, unsigned argc,
                          struct symb_s *argv);
...
extern void compile_vpi_call(char *label, char *name, bool func_as_task_err,
                             bool func_as_task_warn, long file_idx, long lineno,
...
extern void compile_vpi_func_call(char *label, char *name, int val_type,
                                  unsigned val_wid, long file_idx, long lineno,
                                  unsigned argc, vpiHandle *argv,
                                  unsigned vec4_stack, unsigned real_stack,
                                  unsigned string_stack);
...
extern void compile_port_info(unsigned index, int vpi_port_type, unsigned width,
                              const char *name);
...
extern void compile_net_real(char *label, char *name, int msb, int lsb,
                             bool local_flag, unsigned argc,
                             struct symb_s *argv);

extern void compile_netw(char *label, char *array_label,
                         unsigned long array_addr, int msb, int lsb,
                         int vpi_type_code, bool signed_flag, unsigned argc,
                         struct symb_s *argv);
...
extern void compile_island_tranif(int sense, char *island, char *ba, char *bb,
                                  char *src, bool resistive);

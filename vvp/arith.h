...
class vvp_arith_abs : public vvp_net_fun_t {
 public:
  ...
  void recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t);
  void recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t);
...
class vvp_cmp_eq_real : public vvp_arith_real_ {
 public:
  ...
  void recv_real(vvp_net_ptr_t ptr, const double bit, vvp_context_t);
};

...
static long rtl_dist_chi_square(long *seed, long df) {
  ...
  if (df > 0) {
    ...
    vpi_printf(
        "WARNING: Chi_square distribution must have "
...
static long rtl_dist_erlang(long *seed, long k, long mean) {
  ...
  if (k > 0) {
    ...
    vpi_printf(
        "WARNING: K-stage erlangian distribution must have "
        "a positive k\n");
    i = 0;
  }
...
static long rtl_dist_exponential(long *seed, long mean) {
  ...
  if (mean > 0) {
    ...
    vpi_printf(
        "WARNING: Exponential distribution must have "
        "a positive mean\n");
    i = 0;
  }
...
static long rtl_dist_poisson(long *seed, long mean) {
  ...
  if (mean > 0) {
    ...
    vpi_printf(
        "WARNING: Poisson distribution must have "
        "a positive mean\n");
    i = 0;
  }
...
static long rtl_dist_t(long *seed, long df) {
  ...
  if (df > 0) {
    ...
    vpi_printf(
        "WARNING: t distribution must have "
        "a positive degree of freedom\n");
    i = 0;
  }
...
static double uniform(long *seed, long start, long end) {
  ...
  oldseed = *seed;
  if (oldseed == 0) oldseed = 259341593;
  ...
  switch (vpi_get(vpiType, obj)) {
    ...
    case vpiReg:
      if (vpi_get(vpiSize, obj) < 32) {
        ...
        vpi_printf(
            "%s's seed variable is less than 32 bits "
            " (%d).\n",
            name, (int)vpi_get(vpiSize, obj));
    ...
    default:
      vpi_printf("ERROR: %s:%d: ", vpi_get_str(vpiFile, callh),
                 (int)vpi_get(vpiLineNo, callh));
      vpi_printf(
          "%s's seed must be an integer/time"

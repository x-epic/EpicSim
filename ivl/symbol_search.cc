...
static bool symbol_search_scope_first(const LineInfo*li, Design*des, NetScope*scope,
			  pform_name_t path, struct symbol_search_results*res,
			  NetScope*start_scope = 0)
{
      assert(scope);
 ...
 * Compatibility version. Remove me!
 */
NetScope*symbol_search_scopefirst(const LineInfo*li, Design*des, NetScope*scope,
                       pform_name_t path,
		       NetNet*&net,
		       const NetExpr*&par,
		       NetEvent*&eve,

 ...
 * by an EpicSim user using tf_ routines.
 *
 * NOTE 1: EpicSim does not directly support tf_ routines. This
 ...
 *
 * This API is provided by EpicSim only to support legacy software.
 */
 ...
 * are specific to EpicSim, and arrange for automatic loading
 ...
 * Verilog simulators.
 *
 * NOTE: The cadpli module of EpicSim also makes it possible to
...
extern void io_printf(const char*, ...) __attribute__((format(printf, 1, 2)));
...
extern void tf_error(const char*, ...) __attribute__((format(printf, 1, 2)));
...
extern void tf_scale_longdelay(void*, PLI_INT32, PLI_INT32, PLI_INT32*,
                               PLI_INT32*);
extern void tf_unscale_longdelay(void*, PLI_INT32, PLI_INT32, PLI_INT32*,
                                 PLI_INT32*);
...
extern PLI_INT32 tf_message(PLI_INT32 level, char* facility, char* messno,
                            char* fmt, ...)
...
extern void tf_warning(const char*, ...) __attribute__((format(printf, 1, 2)));

...
static NetNet* createRegNode(NetScope* scope)
{
    ...
    NetNet* sig = new NetNet(scope, scope->local_symbol(),
                             NetNet::REG, unpacked_dimensions, vec);
    sig->local_flag(true);
    return sig;
}
...
static NetEvWait* createEvWait(Design* des, NetScope* scope, NetProc* enet, NexusSet* nset)
{
...
static void createAlways(Design* des, NetScope* scope, NetNet* reg, NexusSet* nset)
{

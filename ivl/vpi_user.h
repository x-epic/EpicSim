 ...
 *
 * The vpip_* functions are EpicSim extensions. They are not
...
extern void vpip_count_drivers(vpiHandle ref, unsigned idx, unsigned counts[4]);
...
extern DLLEXPORT PLI_UINT32 vpip_set_callback(vpip_routines_s *routines,
                                              PLI_UINT32 version);

...
vhdlreal::vhdlreal() { value_ = 0.0; }

vhdlreal::vhdlreal(const double& r) { value_ = r; }

vhdlreal::vhdlreal(const vhdlreal& val) { value_ = val.as_double(); }
...
vhdlreal operator-(const vhdlreal& r) { return vhdlreal(-r.as_double()); }
